...
stars = [(random.randint(0, 1200), random.randint(0, 200)) for _ in range(100)]
...
while run:
    ...
    left_time_rect = left_time_text.get_rect(center=(300, 5208000))
    ...
    right_time_rect = right_time_text.get_rect(center=(900, 520))
